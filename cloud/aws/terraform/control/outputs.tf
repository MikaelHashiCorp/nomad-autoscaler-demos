...
Linux AMI Information:
  ID:         ${module.hashistack_image_linux.id}
  OS:         ${module.hashistack_image_linux.os} ${module.hashistack_image_linux.os_version}
  SSH User:   ${module.hashistack_image_linux.ssh_user}
...
`ssh ${module.hashistack_image_linux.ssh_user}@PUBLIC_IP`. You can test the integrity of the cluster by running:
